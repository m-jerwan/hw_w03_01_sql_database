...
--3 Oops! Someone at CodeClan spelled Vicky's name wrong!
--Change it to reflect the proper spelling ('Vicky Jackson-Five' should be 'Vicky Jackson').
UPDATE people
	SET name = 'Vicky Jackson'
	WHERE name = 'Vicky Jackson-Five';
--4 Return ONLY your name from the 'people' table.
SELECT * FROM people WHERE people.name = 'Marcin Jerwan';
...
--6 Create a new entry in the 'people' table with the name of one of
--the instructors.
...
--8 The cinema has just heard that they will be holding an exclusive midnight showing of 'Avengers: Infinity War'!!
--Create a new entry in the 'movies' table to reflect this.
INSERT INTO movies (title, year) VALUES ('Avengers: Infinity War', 2018);
--9 The cinema would also like to make the Guardians movies a back to back feature.
--Find out the show time of "Guardians of the Galaxy" and set the show time of "Guardians of the Galaxy 2" to start two hours later.
